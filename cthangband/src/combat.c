...
/*
 * These algorithms have been taken from the 'Rolemaster Companion'
 * (now probably out of print) and are a rough approximation of the
 * Rolemaster combat system. For a fuller version (especially with
 * respect to the 'Critical' tables) see the current edition of Rolemaster.
 *
 * Dean
 */
#include "angband.h"
...
{
	cptr description;
	s16b stun; /* Chance of stunning */
	s16b bleed; /* Chance of causing bleeding */
	s16b bone; /* chance of breaking bones */
	s16b organ; /* Chance of causing organ damage */
	s16b xtra; /* Chance of causing extra hits */
};

crit crit_table[12][5]=
{
	/* Puncture */
	{
		/* A */
		...
		/* B */
		{
			"It was a penetrating strike",
			5,10,0,0,0
		},
		/* C */
		{
			"The blow stabs heavily.",
			5,15,0,0,0
		},
		/* D */
		{
			"It was a deep strike.",
			5,25,5,5,5
		},
		/* E */
		{
	...
	/* Slash */
	{
		...
		/* B */
		{
			"It was a tearing cut.",
			5,10,0,0,0
		},
		/* C */
		{
			"The blow causes a huge gash.",
			10,10,5,0,0
		},
		/* D */
		{
	...
	/* Krush */
	{
		...
		/* C */
		{
			"It was a hefty strike.",
			15,0,20,0,10
		},
		/* D */
		{
			"The blow hammers home.",
			25,0,30,5,10
		},
		/* E */
		{
	...
	/* Grapple */
	{
		/* A */
		{
			"It was a grasping strike.",
			5,0,0,0,0
		},
		/* B */
		{
			"It was a grabbing strike.",
			10,0,0,0,0
		},
		/* C */
		{
			"It was a wrapping strike.",
			10,0,5,0,0
		},
		/* D */
		{
			"It was an enveloping strike.",
			10,0,10,0,5
		},
		/* E */
		{
			"It was a smothering strike.",
			10,0,15,0,5
		}
	},
	/* Strikes */
	{
		...
		/* C */
		{
			"It was a combination strike.",
			15,0,10,0,5
		},
		/* D */
		{
			"It was a spinning kick.",
			20,0,20,0,10
		},
		/* E */
		{
	...
	/* Sweeps */
	{
		...
		/* B */
		{
			"It was a rolling throw.",
			10,0,0,0,0
		},
		/* C */
		{
			"It was a weighty sweep.",
			15,0,0,0,5
		},
		/* D */
		{
			"It was an effective sweep.",
			20,0,0,0,5
		},
		/* E */
		{
			"It was an acrobatic throw.",
			30,0,0,0,5
		}
	},
	/* Electric */
...
void crit_damage(s16b table,s16b severity,s16b *stun,s16b *bleed, s16b *bone,s16b *organ,s16b *xtra)
{
	...
	*xtra = 0;
	...
	result = crit_table[table][severity-1];

	while (rand_range(1,50) <= result.stun)
	{
		(*stun)++;
	};

	while (rand_range(1,50) <= result.bleed)
	{
		(*bleed)++;
	};

	while (rand_range(1,50) <= result.bone)
	{
		(*bone)++;
	};

	while (rand_range(1,50) <= result.organ)
	{
		(*organ)++;
	};

	while (rand_range(1,50) <= result.xtra)
	{
		(*xtra)+= 5;
	};

	msg_print(result.description);
}