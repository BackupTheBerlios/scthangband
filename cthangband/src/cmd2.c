...
{POWER_MUTA, MUT_SPIT_ACID, 9, 9, A_DEX, 15, "spit acid","dam lvl"},
{POWER_MUTA, MUT_BR_FIRE, 20, -1, A_CON, 18, "fire breath","dam lvl*2"},
{POWER_MUTA, MUT_HYPN_GAZE, 12, 12, A_CHR, 18, "hypnotic gaze",0},
{POWER_MUTA, MUT_TELEKINES, 9, 9, A_WIS, 14, "telekinesis",0},
{POWER_MUTA, MUT_VTELEPORT, 7, 7, A_WIS, 15, "teleport",0},
{POWER_MUTA, MUT_MIND_BLST, 5, 3, A_WIS, 15, "mind blast",0},
{POWER_MUTA, MUT_RADIATION, 15, 15, A_CON, 14, "emit radiation",0},
{POWER_MUTA, MUT_VAMPIRISM, 13, -1, A_CON, 14, "vampiric drain",0},
{POWER_MUTA, MUT_SMELL_MET, 3, 2, A_INT, 12, "smell metal",0},
{POWER_MUTA, MUT_SMELL_MON, 5, 4, A_INT, 15, "smell monsters",0},
{POWER_MUTA, MUT_BLINK, 3, 3, A_WIS, 12, "blink",0},
{POWER_MUTA, MUT_EAT_ROCK, 8, 12, A_CON, 18, "eat rock",0},
{POWER_MUTA, MUT_SWAP_POS, 15, 12, A_DEX, 16, "swap position",0},
{POWER_MUTA, MUT_SHRIEK, 4, 4, A_CON, 6, "shriek",0},
{POWER_MUTA, MUT_ILLUMINE, 3, 2, A_INT, 10, "illuminate",0},
{POWER_MUTA, MUT_DET_CURSE, 7, 14, A_WIS, 14, "detect curses",0},
{POWER_MUTA, MUT_BERSERK, 8, 8, A_STR, 14, "berserk",0},
{POWER_MUTA, MUT_POLYMORPH, 18, 20, A_CON, 18, "polymorph",0},
{POWER_MUTA, MUT_MIDAS_TCH, 10, 5, A_INT, 12, "midas touch",0},
{POWER_MUTA, MUT_GROW_MOLD, 1, 6, A_CON, 14, "grow mold",0},
{POWER_MUTA, MUT_RESIST, 10, 12, A_CON, 12, "resist elements",0},
{POWER_MUTA, MUT_EARTHQUAKE, 12, 12, A_STR, 16, "earthquake",0},
{POWER_MUTA, MUT_EAT_MAGIC, 17, 1, A_WIS, 15, "eat magic",0},
{POWER_MUTA, MUT_WEIGH_MAG, 6, 6, A_INT, 10, "weigh magic",0},
{POWER_MUTA, MUT_STERILITY, 20, 40, A_CHR, 18, "sterilize",0},
{POWER_MUTA, MUT_PANIC_HIT, 10, 12, A_DEX, 14, "panic hit",0},
{POWER_MUTA, MUT_DAZZLE, 7, 15, A_CHR, 8, "dazzle",0},
{POWER_MUTA, MUT_EYE_BEAM, 7, 10, A_WIS, 9, "eye beams",0},
{POWER_MUTA, MUT_RECALL, 17, 50, A_INT, 16, "recall",0},
{POWER_MUTA, MUT_BANISH, 25, 25, A_WIS, 18, "banish evil",0},
{POWER_MUTA, MUT_COLD_TOUCH, 2, 2, A_CON, 11, "cold touch",0},
{POWER_MUTA, MUT_LAUNCHER, 1, -1, A_STR, 6, "throw object",0},
