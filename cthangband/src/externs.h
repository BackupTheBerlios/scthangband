...
#endif
#if (defined(BIRTH_C) || defined(CMD1_C) || defined(FILES_C) || defined(LOAD_C) || defined(POWERS_C) || defined(SPELLS2_C) || defined(VARIABLE_C) || defined(XTRA1_C) || defined(XTRA2_C))
