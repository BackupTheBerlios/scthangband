...
/*
 * Hack - use suitable macros for various systems to avoid duplicating function
 * names. Hopefully it still compiles...
 */

#ifdef USE_VME /* Does any of this stuff work? */
# define unlink(a) unlink_vme(a)
# define lseek(a,b,c) lseek_vme(a,b,c)
# define write(a,b,c) write_vme(a,b,c)
# define read(a,b,c) read_vme(a,b,c)
# define close(a) close_vme(a)
# define open(a,b,c) open_vme(a,b,c)
#endif

#ifndef HAS_USLEEP
# define usleep(a) usleep_ang(a)
#endif /* HAVE_USLEEP */

#ifdef USE_SLA
# define has_colors() has_colors_sla()
#endif

#ifdef USE_IBM
# ifdef USE_GRAPHICS
#  ifdef USE_286
#   define enable_graphic_font enable_graphic_font_286(a)
#  else /* USE_286 */
#   define enable_graphic_font enable_graphic_font_386(a)
#  endif /* USE_286 */
# endif /* ALLOW_GRAPH */
#endif /* USE_IBM */

#ifdef HANDLE_SIGNALS
#define signals_init() signals_init_1()
#else	/* HANDLE_SIGNALS */
#define signals_init() signals_init_2()
#endif
...
#ifndef ACORN
# ifdef SET_UID
#  define path_parse(buf, max, file) path_parse_1(buf, max, file)
# else /* SET_UID */
#  define path_parse(buf, max, file) path_parse_2(buf, max, file)
# endif /* SET_UID */
#endif /* ACORN */

/* main-acn.c */
#ifdef __riscos
# define fd_make(a,b) fd_make_acn(a,b)
# define my_fclose(a) my_fclose_acn(a)
# define fd_lock(a,b) fd_lock_acn(a,b)
# define fd_open(a,b) fd_open_acn(a,b)
# define fd_kill(a) fd_kill_acn(a)
# define fd_close(d) fd_close_acn(d)
# define fd_seek(fd,n) fd_seek_acn(fd,n)
# define fd_move(a,b) fd_move_acn(a,b)
# define my_fopen(filename, mode) my_fopen_acn(filename, mode)
# define path_temp(a,b) path_temp_ros(a,b)
# define fd_read(a,b,c) fd_read_ros(a,b,c)
# define fd_write(a,b,c) fd_write_ros(a,b,c)
#else /* __riscos */
# define fd_lock(a,b) fd_lock_ang(a,b)
# define fd_make(a,b) fd_make_ang(a,b)
# define my_fclose(a) my_fclose_ang(a)
# define fd_open(a,b) fd_open_ang(a,b)
# define fd_kill(a) fd_kill_ang(a)
# define fd_close(d) fd_close_ang(d)
# define fd_seek(fd,n) fd_seek_ang(fd,n)
# define fd_move(a,b) fd_move_ang(a,b)
# define my_fopen(filename, mode) my_fopen_ang(filename, mode)
# define path_temp(a,b) path_temp_ang(a,b)
# define fd_read(a,b,c) fd_read_ang(a,b,c)
# define fd_write(a,b,c) fd_write_ang(a,b,c)
#endif /* __riscos */
...
/* util.c */
#ifndef HAS_MEMSET
# define memset(s,c,n) memset_ang(s,c,n)
#endif
...
/* files.c */
#ifdef HANDLE_SIGNALS
# define signals_handle_tstp() signals_handle_tstp_1()
# define signals_ignore_tstp() signals_ignore_tstp_1()
#else	/* HANDLE_SIGNALS */
# define signals_handle_tstp(void) signals_handle_tstp_2()
# define signals_ignore_tstp() signals_ignore_tstp_2()
