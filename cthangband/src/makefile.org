...
SRCS = \
  ...
  quest.c \
  main-xpj.c main-gtk.c main-gcu.c main-x11.c maid-x11.c main-xaw.c main.c
...
OBJS = \
  ...
  quest.o \
  main-xpj.o main-gtk.o main-gcu.o main-x11.o maid-x11.o main-xaw.o main.o
...
CFLAGS = -O3 -fno-strength-reduce -pipe -g -D"USE_X11" -D"USE_GCU" -D"USE_XPJ" \
	-D"USE_TRANSPARENCY" -D"USE_GTK" `gtk-config --cflags` \
...
#	-ansi -pedantic -D"NO_VARIABLE_ARRAYS" \

LIBS = -lX11 -lcurses -ltermcap -L/usr/X11R6/lib `gtk-config --libs` 

##
## Variation -- Only support "main-x11.c" and "main-gcu.c", not "main-gtk.c"
##
#CFLAGS = -O3 -fno-strength-reduce -pipe -g -D"USE_X11" -D"USE_GCU" \
#	-D"USE_TRANSPARENCY" \
#	-W -Wall -Wmissing-prototypes -Wmissing-declarations \
...
#         -D"USE_X11" -D"USE_GCU" -D"USE_NCURSES" --ansi -pedantic -W
