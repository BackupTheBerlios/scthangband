...
SRCS = \
  ...
  object1.c object2.c quest.c powers.c readdib.c save.c spells1.c spells2.c store.c \
  tables.c util.c variable.c wizard1.c wizard2.c xtra1.c xtra2.c z-form.c \
  z-rand.c z-term.c z-util.c z-virt.c main-crb.o
...
OBJS = \
  ...
  object1.o object2.o quest.o powers.o readdib.o save.o spells1.o spells2.o store.o \
  tables.o util.o variable.o wizard1.o wizard2.o xtra1.o xtra2.o z-form.o \
  z-rand.o z-term.o z-util.o z-virt.o main-crb.o
